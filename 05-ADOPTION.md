...
### 步骤 3：配置仓库双许可文件 / Step 3: Configure Repository Dual-License Files
将以下文件放置于项目仓库根目录，保持命名规范与官方基准仓库一致：
- `LICENSE`：放置 QNLOO-SPL 主许可全文
- `LICENSE-APACHE`：放置 Apache License 2.0 全文
- `PATENTS`：放置项目专利授权说明书
...
- `LICENSE`: Contains the full text of the QNLOO-SPL main license
- `LICENSE-APACHE`: Contains the full text of the Apache License 2.0
- `PATENTS`: Contains the project patent grant addendum
...
2. Core mechanism positioning of sovereign statutory digital currency settlement;
