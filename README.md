# QNLOO-SPL 主权公开许可范式官方基准仓库 / QNLOO-SPL Sovereign Public License Paradigm Official Reference Repository

本仓库是 **QNLOO-SPL（千年鹿主权公开许可范式）** 的唯一官方标准仓库，面向全球开发者和企业提供一套独立、可复用、行业通用的数字资产许可标准，当前最新稳定版本为 **v1.1**。

This repository is the sole official standard repository for the **QNLOO-SPL (QNLOO Sovereign Public License Paradigm)**, providing a standalone, reusable, and industry-universal digital asset licensing standard for developers and enterprises worldwide. The latest stable version is **v1.1**.
...
- 主权价值协议解决「价值要不要对齐、如何按主权规则分配」的问题，核心是生态治理与价值主权。

QNLOO-SPL belongs to the new **Sovereign Value Protocol** category, parallel to traditional open-source licenses represented by Apache 2.0, corresponding to different industrial stages and core demands:
- Traditional open-source licenses address "whether and how to share source code", focusing on technical collaboration efficiency;
...
| :--- | :--- | :--- |
| **核心定位**<br>**Core Positioning** | 代码共享许可，保障技术自由流通<br>Code sharing license, ensuring free circulation of technology | 主权商事价值分配范式，保障价值按主权规则流转<br>Sovereign commercial value distribution paradigm, ensuring value circulation per sovereign rules |
| **底层逻辑**<br>**Underlying Logic** | 基于版权体系的授权，放弃商用收益权<br>Authorization based on copyright system, waiving commercial revenue rights | 基于主权规则的分润，保留价值分配与治理权<br>Revenue sharing based on sovereign rules, retaining value distribution and governance rights |
| **覆盖资产**<br>**Covered Assets** | 仅源代码类资产<br>Only source code assets | 源代码 + 文本/专利/认知逻辑/商用运营等全量数字资产<br>Full digital assets including source code, texts, patents, cognitive logic and commercial operations |
| **商用规则**<br>**Commercial Rules** | 无差别免费商用，无价值分配机制<br>Unified free commercial use, no value distribution mechanism | 梯度分层授权，小微豁免、超额分润、全链路价值闭环<br>Progressive tiered authorization: small entity exemption, excess revenue sharing, full-link value loop |
| **主权属性**<br>**Sovereign Attribute** | 无属地主权绑定，全球无差别适用<br>No territorial sovereign binding, uniformly applicable worldwide | 锚定主权法定货币与合规体系，适配属地司法与治理要求<br>Anchored to sovereign CBDC and compliance systems, adapted to local judicial and governance requirements |
| **典型场景**<br>**Typical Scenarios** | 通用技术组件、基础工具类开源项目<br>General technical components and basic tool open-source projects | 主权AI、数据要素、行业智能体、数字生态等需价值对齐的场景<br>Scenarios requiring value alignment: sovereign AI, data elements, industrial agents, digital ecosystems |
...
Any enterprise, team, or individual may adopt the QNLOO-SPL paradigm by following these steps:

1. 下载模板 Clone or download the `template/` directory

2. 替换资产持有主体信息 Replace the asset holding entity information

3. 在项目 README 中标注 Label your project as "本项目采用 QNLOO-SPL 主权公开许可范式 / Licensed under the QNLOO-SPL Sovereign Public License Paradigm"

4. 核心法律条款禁止私自删减修改，仅可替换资产持有主体、本地化营收阈值等基础参数 Core legal clauses must not be altered or removed; only basic parameters such as the asset holding entity and localized revenue thresholds may be replaced
...
| :--- | :--- | :--- |
| QNLOO-SPL v1.0 | 2026年6月30日 | 范式首次正式发布<br>Initial official release of the paradigm |
| QNLOO-SPL v1.1 | 2026年7月4日 | 新增赏金权利让渡机制与双线支付规则，优化属地管辖与诉讼主体资格条款，强化规则制定者风险隔离<br>Added bounty right assignment mechanism and dual-channel payment rules; optimized territorial jurisdiction and litigation subject qualification clauses; strengthened risk isolation for rule makers |

版本命名规则：QNLOO-SPL vX.Y。主仓库永久保留最新版，旧版移入 `archive/` 归档。

Version naming convention: QNLOO-SPL vX.Y. The latest version is permanently maintained in the main repository, with prior versions archived in `archive/`.
